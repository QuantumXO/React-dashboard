...
const initialState = {
    ordersArr: [
        ...
        {id: '1', date: '01.11.2013', time: '23:18:03', reference: 'kfrzrm', img: '//robohash.org/5db6d41ad263c3e41bedad3f4078ca93.png?size=25x25', customer: 'Hettie Carson', nbItems: '2', total: '80,94', status: 'delivered', returned: 'true' },
...
export default function ordersReducer(state = initialState, action){
    switch (action.type) {
        ...
        case 'DELETE_ORDER':
            ...
            deleteState.ordersArr.splice(action.payload, 1);
            return {
                ...deleteState
            };
            break;
        case 'NEW_STATUS':
            ...
            newState.ordersArr[action.payload.id].status = action.payload.status;
            return{
                ...newState
            };	
        default:
